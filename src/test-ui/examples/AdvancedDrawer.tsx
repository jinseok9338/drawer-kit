...
export default function AdvancedDrawer() {
  ...
  const openSnapPointsDrawer = () => {
    console.log("Opening snap points drawer...");
    drawer.open(
      ({ close }) => (
        <div style={{ padding: "20px", background: "white", borderRadius: "8px" }}>
          <h3 style={{ margin: "0 0 15px 0" }}>Snap Points Drawer</h3>
          <p style={{ margin: "0 0 20px 0", color: "#666" }}>
            This drawer has snap points at 25%, 50%, and 90% of the screen height. Try dragging it
            to different positions!
          </p>
          <div style={{ marginBottom: "20px" }}>
            <h4 style={{ margin: "0 0 10px 0", fontSize: "16px" }}>Content</h4>
            <div
              style={{
                height: "200px",
                overflowY: "auto",
            ...
            >
              {Array.from({ length: 20 }, (_, i) => (
                <p key={i} style={{ margin: "10px 0", color: "#666" }}>
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "30px" }}>
        {/* Snap Points Drawer */}
        <section>
          <h3 style={{ margin: "0 0 10px 0", color: "#555" }}>Snap Points Drawer</h3>
          <p style={{ margin: "0 0 15px 0", color: "#666", fontSize: "14px" }}>
            Drawer with predefined snap points at 25%, 50%, and 90% of screen height.
          </p>
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
            <button
              onClick={openSnapPointsDrawer}
              style={{
                padding: "12px 24px",
                background: "#6f42c1",
                color: "white",
            ...
            <button
              onClick={() => {
                console.log("Opening simple drawer...");
                drawer.open(
                  ({ close }) => (
                    <div style={{ padding: "20px", background: "white", borderRadius: "8px" }}>
                      <h3 style={{ margin: "0 0 15px 0" }}>Simple Test Drawer</h3>
                      <p style={{ margin: "0 0 20px 0", color: "#666" }}>
                        This is a simple drawer without snap points for testing.
                      </p>
                      <button
                        onClick={close}
                        style={{
        ...
        {/* Advanced Vaul API Options */}
        <section>
          <h3 style={{ margin: "0 0 10px 0", color: "#555" }}>Advanced Vaul API Options</h3>
          <p style={{ margin: "0 0 15px 0", color: "#666", fontSize: "14px" }}>
            Test various vaul API options like shouldScaleBackground, autoFocus, and animation
            callbacks.
          </p>
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
            <button
              onClick={() => {
                drawer.open(
                  ({ close }) => (
                    <div style={{ padding: "20px", background: "white", borderRadius: "8px" }}>
                      <h3 style={{ margin: "0 0 15px 0" }}>Scale Background Drawer</h3>
                      <p style={{ margin: "0 0 20px 0", color: "#666" }}>
                        This drawer scales the background when opened. Notice the background effect!
                      </p>
                      <button
                        onClick={close}
                        style={{
            ...
            <button
              onClick={() => {
                drawer.open(
                  ({ close }) => (
                    <div style={{ padding: "20px", background: "white", borderRadius: "8px" }}>
                      <h3 style={{ margin: "0 0 15px 0" }}>Auto Focus Drawer</h3>
                      <p style={{ margin: "0 0 20px 0", color: "#666" }}>
                        This drawer automatically focuses when opened.
                      </p>
                      <input
                        type="text"
                        placeholder="This input should be focused automatically"
                        style={{
                          width: "100%",
                          padding: "8px",
                          marginBottom: "15px",
            ...
            <button
              onClick={() => {
                ...
                drawer.open(
                  ({ close }) => (
                    <div style={{ padding: "20px", background: "white", borderRadius: "8px" }}>
                      <h3 style={{ margin: "0 0 15px 0" }}>Animation Callback Drawer</h3>
                      <p style={{ margin: "0 0 20px 0", color: "#666" }}>
                        This drawer logs animation events. Check the console!
                      </p>
                      <p style={{ margin: "0 0 15px 0", color: "#666", fontSize: "14px" }}>
                        Animation events logged: {animationCount}
                      </p>
                      <button
                        onClick={close}
                        style={{
                  ...
                  ),
                  {
                    ...
                    onAnimationEnd: (open) => {
                      animationCount++;
                      console.log(
                        `Animation ended: ${open ? "opened" : "closed"} (${animationCount})`
                      );
                    },
                  }
                );
            ...
            <button
              onClick={() => {
                drawer.open(
                  ({ close }) => (
                    <div style={{ padding: "20px", background: "white", borderRadius: "8px" }}>
                      <h3 style={{ margin: "0 0 15px 0" }}>Custom Threshold Drawer</h3>
                      <p style={{ margin: "0 0 20px 0", color: "#666" }}>
                        This drawer requires dragging 75% to close (instead of default 25%).
                      </p>
                      <button
                        onClick={close}
                        style={{
